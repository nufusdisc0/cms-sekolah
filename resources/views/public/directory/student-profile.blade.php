...
@section('title', $student->full_name . ' - Direktori Siswa')

@section('content')
<div class="container py-5">
    <!-- Back Button -->
    <div class="mb-4">
        <a href="{{ route('public.directory.students') }}" class="btn btn-sm btn-outline-secondary">
        ...
        <div class="col-lg-4 mb-4">
            <div class="card border-0 shadow-sm sticky-top" style="top: 20px;">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-3">Siswa Aktif</p>

                    @if($student->major)
                        <div class="badge bg-info mb-3" style="font-size: 0.9rem;">
                            {{ $student->major->name }}
                        </div>
                    @endif
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p class="text-muted small mb-1">Rombongan Belajar</p>
                            <p class="mb-0">
                                <strong>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <p class="mb-0">
                                ...
                                @elseif($student->status === 'prospective')
                                    <span class="badge bg-info">Calon Siswa</span>
                                @else
                        ...
                        <div class="col-md-6">
                            <p class="text-muted small mb-1">Nomor Induk Siswa Lokal</p>
                            <p class="mb-0"><strong>{{ $student->student_number ?? '-' }}</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p class="text-muted small mb-1">Tahun Kelulusan (Direncanakan)</p>
                            <p class="mb-0">
                                <strong>
                                    @if($student->end_date)
