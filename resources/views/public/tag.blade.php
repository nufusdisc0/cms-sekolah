...
@section('title', 'Tag: ' . $tag->tag . ' - ' . config('app.name'))

@section('content')
<div class="container py-5">
    <h2>Menampilkan Artikel dengan Tag: <span class="text-primary">#{{ $tag->tag }}</span></h2>
    <hr>
    <div class="row">
        ...
        @empty
        <div class="col-12"><p class="text-muted">Belum ada berita yang menggunakan tag ini.</p></div>
        @endforelse
    </div>
    {{ $posts->links() }}
</div>
