    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Pengguna {{ config('app.employee_label', 'Guru dan Tenaga Kependidikan') }}</h5>
            </div>
            <div class="card-body">
                @if(session('success'))
                            ...
                            <div class="modal fade" id="editPasswordModal-{{ $user->id }}" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('backend.user_employees.update', $user->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="modal-header">
                                                <h5 class="modal-title">Ubah Password Pegawai</h5>
