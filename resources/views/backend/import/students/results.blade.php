...
@section('title', 'Hasil Impor Data Siswa')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 mb-0">
                <i class="fas fa-list text-primary me-2"></i>Hasil Impor Data Siswa
            </h1>
            <p class="text-muted small">{{ $importLog->created_at->format('d/m/Y H:i') }}</p>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('backend.import.students.form') }}" class="btn btn-outline-secondary btn-sm">
    ...
    @if($importLog->failed_rows > 0 || $importLog->duplicate_rows > 0)
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('backend.import.students.download-errors', $importLog) }}" class="btn btn-outline-danger btn-sm">
