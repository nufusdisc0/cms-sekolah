...
@section('title', 'Pratinjau Impor Data Karyawan')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 mb-0">
                <i class="fas fa-eye text-primary me-2"></i>Pratinjau Data Karyawan
            </h1>
            <p class="text-muted small">Periksa data sebelum mengonfirmasi impor - {{ $totalRows }} baris ditemukan</p>
        </div>
        <div class="col-md-4 text-end">
            <a href="{{ route('backend.import.employees.form') }}" class="btn btn-outline-secondary">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <form action="{{ route('backend.import.employees.process') }}" method="POST">
                @csrf
