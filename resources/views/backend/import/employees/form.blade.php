...
@section('title', 'Impor Data Karyawan')
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-8">
            <h1 class="h3 mb-0">
                <i class="fas fa-upload text-primary me-2"></i>Impor Data Karyawan
            </h1>
            <p class="text-muted small">Impor daftar karyawan dari file CSV</p>
        </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-light">
                    <h5 class="mb-0">Unggah File Data Karyawan</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('backend.import.employees.preview') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('backend.import.employees.template') }}" class="btn btn-outline-primary btn-sm w-100">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <ul class="small ps-3 mb-0">
                        ...
                        <li class="mb-2">Pastikan NIK dan email unik untuk setiap karyawan</li>
                        <li class="mb-2">Format tanggal: YYYY-MM-DD (contoh: 1985-05-20)</li>
